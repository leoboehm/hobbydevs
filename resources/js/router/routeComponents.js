...
export const routeComponents = {
  ...
  Devs: () => import('../views/developers/DevelopersListView.vue'),
  ...
  PostProject: () => import('../views/projects/EnlistProjectView.vue'),
  ProjectDetail: () => import('../views/projects/ProjectDetailView.vue'),
