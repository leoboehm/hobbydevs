  ...
  <v-form ref="form" v-model="valid" lazy-validation>
    <v-stepper v-model="currentStep">
      <v-stepper-header>
        ...
        <v-stepper-item title="Duration & Salary" value="2"></v-stepper-item>
      ...
      <v-stepper-window>
        <v-stepper-window-item step="1" value="1">
          <v-card flat>
            ...
            <v-card-actions>
              <v-spacer></v-spacer
              ><v-btn @click="currentStep += 1" class="mx-2 text-green"
                >Next</v-btn
              >
            </v-card-actions>
          </v-card>
        ...
        <v-stepper-window-item value="2" step="2">
          <v-card flat>
            ...
            <v-card-actions>
              <v-btn @click="currentStep -= 1" class="mx-2">Previous</v-btn
              ><v-spacer></v-spacer
              ><v-btn @click="currentStep += 1" class="mx-2 text-green"
                >Next</v-btn
              >
