        ...
        <v-card elevation="2" style="width: 80vw; max-width: 1200px" class="px-4 py-4">
            ...
            <v-card-text>
                <v-form ref="form" v-model="valid" lazy-validation>
                    ...
                    <!-- Skills (with tags) -->
                    <v-combobox v-model="skills" :items="availableSkills" label="Skills" multiple outlined chips
                        clearable small-chips></v-combobox>

                    <!-- Availability -->
                    <v-text-field v-model="availability" :rules="[rules.required]"
                        label="Availability (e.g., 20 hours/week)" outlined required></v-text-field>
                    ...
                    <!-- Motivation -->
                    <v-textarea v-model="motivation" :rules="[rules.required]" label="Motivation" outlined
                        required></v-textarea>
